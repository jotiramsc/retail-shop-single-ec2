...
public class FacebookPublisher implements SocialPublisher {
    ...
    public MarketingPlatform platform() {
        return MarketingPlatform.FACEBOOK;
    }

    @Override
    public PublishResult publish(CampaignContent content) {
        Campaign campaign = buildLegacyCampaign(content, CampaignType.FACEBOOK);
        MarketingChannelResult result = socialMediaService.publishFacebook(campaign);
