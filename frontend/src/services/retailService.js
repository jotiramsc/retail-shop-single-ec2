...
export const retailService = {
  ...
  getPublicProductBySlug: (slug) => api.get(`/products/catalog/slug/${encodeURIComponent(slug)}`).then((res) => res.data),
  recordCampaignLeadVisit: (payload) => api.post('/campaign-leads/visits', payload).then((res) => res.data),
