...
insert into receipt_settings (id, shop_name, header_line, logo_url, login_kicker, homepage_title, homepage_subtitle, hero_primary_image_url, hero_secondary_image_url, trust_badge_one, trust_badge_two, trust_badge_three, trust_badge_four, address, phone_number, gst_number, footer_note, show_address, show_phone_number, show_gst_number)
values
    ('d1111111-1111-1111-1111-111111111111', 'Luxe Retail Studio', 'Ladies Cosmetics and Jewellery', '', 'Customer Access', 'Shine brighter every day with KPSKRISHNAI.', 'Explore customer-ready jewellery operations inspired by KPSKRISHNAI''s storefront, with pearls, bangles, and mangalsutra collections at the center.', '', '', 'Premium quality designs', 'Secure payments', 'Worldwide shipping', 'Festive and daily-wear collections', '12 Fashion Street, City Center', '+91 98765 43210', 'GSTIN-22ABCDE1234F1Z5', 'Thank you for shopping with us', true, true, false)
on conflict (id) do nothing;
